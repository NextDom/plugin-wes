...
class wes_teleinfo extends eqLogic {
	...
	private function getListeDefaultCommandes()
	{
		...
		"BASE_evolution" => array('Evolution index (base)', 'numeric', 'Wh/min', 1, "BASE"),
		"HCHC_evolution" => array('Evolution index (heures creuses)', 'numeric', 'Wh/min', 1, "HC"),
		"HCHP_evolution" => array('Evolution index (heures pleines)', 'numeric', 'Wh/min', 1, "HC"),
		"BBRHCJB_evolution" => array('Evolution index (heures creuses jours bleus Tempo)', 'numeric', 'Wh/min', 0, "BBRH"),
		"BBRHPJB_evolution" => array('Evolution index (heures pleines jours bleus Tempo)', 'numeric', 'Wh/min', 0, "BBRH"),
		"BBRHCJW_evolution" => array('Evolution index (heures creuses jours blancs Tempo)', 'numeric', 'Wh/min', 0, "BBRH"),
		"BBRHPJW_evolution" => array('Evolution index (heures pleines jours blancs Tempo)', 'numeric', 'Wh/min', 0, "BBRH"),
		"BBRHCJR_evolution" => array('Evolution index (heures creuses jours rouges Tempo)', 'numeric', 'Wh/min', 0, "BBRH"),
		"BBRHPJR_evolution" => array('Evolution index (heures pleines jours rouges Tempo)', 'numeric', 'Wh/min', 0, "BBRH"),
		"EJPHN_evolution" => array('Evolution index (normal EJP)', 'numeric', 'Wh/min', 0, "EJP"),
		"EJPHPM_evolution" => array('Evolution index (pointe mobile EJP)', 'numeric', 'Wh/min', 0, "EJP"));
	}
